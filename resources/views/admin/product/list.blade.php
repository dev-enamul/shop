          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3" style="display:flex; justify-content: space-between;align-items: center; padding:0 10px">
                <h6 class="text-white text-capitalize  ">Product List</h6>
                <a href="{{url('/product/create')}}" class="btn btn-light  ">Add Product</a>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary opacity-7">Small Desc</th> 
                  ...
                  <tbody> 
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">{{$data->small_description}}</p> 
                      </td>
                      ...
                      <td class="align-middle">
                        <a href="{{url('/product/edit/'.$data->id)}}" class="btn btn-success" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                        <a href="{{url('/product/delete/'.$data->id)}}" class="btn btn-danger" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr> 
